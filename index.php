  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-1">INVENTORI BARANG</div>
      </a>
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
     ...
     <li class="nav-item ">
      ...
      <div class="d-flex align-items-center justify-content-center" class="email">  Anda adalah Admin </b></div>
     </a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="?page=pengguna" data-toggle="collapse" data-target="#collapseData" aria-expanded="true" aria-controls="collapseData">
          <i class="fas fa-fw fa-folder"></i>
          <span>Data Gudang</span>
        </a>
        <div id="collapseData" class="collapse" aria-ledby="headingPages" data-parent="#accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-ledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item active">
        ...
        <div id="collapseLaporan" class="collapse" aria-ledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
